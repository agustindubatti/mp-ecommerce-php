...
<div class="stack">
    ...
    <div class="as-search-wrapper" role="main">
        ...
        <div>
            ...
            <h3>Collection ID: <?php echo $collection_id?></h3>
            <h3>Collection Status: <?php echo $collection_status?></h3>
            <h3>External reference: <?php echo $external_reference?></h3>
            <h3>Payment type: <?php echo $payment_type?></h3>
            <h3>Merchant Order ID: <?php echo $merchant_order_id?></h3>
            <h3>Preference ID: <?php echo $preference_id?></h3>
            <h3>Site ID: <?php echo $site_id?></h3>
            <h3>Processing Mode: <?php echo $processing_mode?></h3>
            <h3>Merchan Account ID: <?php echo $merchant_account_id?></h3>
        </div>
    </div>
</div>
